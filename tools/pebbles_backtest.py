"""Local backtest for pebbles_trader.Trader against historical Round 5 CSVs.
...
import pebbles_trader as ptrader

PRODUCTS = ptrader.PRODUCTS
POS_LIMIT = ptrader.POS_LIMIT
INVARIANT_SUM = ptrader.INVARIANT_SUM
